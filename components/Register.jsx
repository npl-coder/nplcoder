  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <button className={`${buttonStyles} ${commonButtonStyles}`}>
          Register Now
        </button>
      </DialogTrigger>

      <DialogContent className="fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] bg-white w-[90%] max-w-[95vw] sm:max-w-6xl p-4 sm:p-8 rounded-3xl z-[101] overflow-y-auto max-h-[90vh] sm:max-h-full">
        <DialogHeader className="flex flex-row justify-between items-start mb-4 sm:mb-8">
          <DialogTitle className="text-2xl sm:text-3xl font-bold text-slate-900">Register</DialogTitle>
        </DialogHeader>
