        ...
        <div className="flex-1 text-left">
          ...
          <div className="flex flex-row gap-4 mb-12">
            <a href="https://forms.gle/Z4bPVsWo5sdQLEvs5" target="_blank" rel="noreferrer">
              <button className="bg-gradient-to-r hover:scale-105 from-[#dc143ce0] to-[#003893d7] text-white py-3 sm:py-4 px-6 rounded-xl font-semibold mt-4 sm:mt-6 hover:shadow-lg transition duration-300">
                {t('joinbutton')}
              </button>
            </a>
            <a href="/about">
